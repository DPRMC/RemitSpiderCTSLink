 ...
 *
 */
class CustodianCtsCmbsRestrictedServicerReportDlsr extends AbstractCustodianCtsCmbsRestrictedServicerReportTab {
...
//    const document_id                                             = 'document_id';
    ...
    const preced_fy_finan_as_of_date                              = 'preced_fy_finan_as_of_date';
    const most_recent_finan_as_of_end_date                        = 'most_recent_finan_as_of_end_date';
    ...
    protected $casts = [
        ...
        self::preced_fy_finan_as_of_date                              => 'date',
        self::most_recent_finan_as_of_end_date                        => 'date',
