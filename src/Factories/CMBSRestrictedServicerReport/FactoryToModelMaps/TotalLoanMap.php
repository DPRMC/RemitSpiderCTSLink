...
class TotalLoanMap extends AbstractFactoryToModelMap {
    ...
    public static array $map = [
        ...
        CustodianCtsCmbsRestrictedServicerReportTotalLoan::special_servicer_workout_control_type           => [
                                                                                                                'special_servicer_workout_control_type',
                                                                                                                'workout_control_type'],
        CustodianCtsCmbsRestrictedServicerReportTotalLoan::current_controlling_holder_or_operating_advisor => [
                                                                                                                'current_controlling_holder_or_operating_advisor',
                                                                                                                 'holder_or_operating_advisor'],
        CustodianCtsCmbsRestrictedServicerReportTotalLoan::controlling_class_rights                        => [
                                                                                                                'controlling_class_rights',
                                                                                                                'class_rights'],
        CustodianCtsCmbsRestrictedServicerReportTotalLoan::current_lockbox_status                          => [
